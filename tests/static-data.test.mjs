...
test('rejects impossible calendar dates and observations newer than their snapshot',()=>{for(const observed_at of ['2026-02-30T10:00:00+08:00','2026-09-20T10:00:00+08:00'])assert.throws(()=>parseSnapshot(snapshot([{...note,observed_at}])));});
