...
const files=['README.md','package.json','package-lock.json','index.html','tsconfig.json','vite.config.ts','.gitignore','src/Boundary.tsx','src/Explore.tsx','src/Form.tsx','src/Map.tsx','src/main.tsx','src/ui.tsx','src/site.ts','src/data.ts','src/publicPlaces.ts','src/base.css','src/theme.css','src/app.css','src/botanical.svg','src/env.d.ts','shared/domain.ts','shared/snapshot.ts','scripts/lib.mjs','scripts/prepare-data.mjs','scripts/publish-data.mjs','scripts/check-release.mjs','scripts/package-pages.mjs','tests/static-data.test.mjs','qualtrics/campus-sound-notes-survey.txt','qualtrics/SETUP.md','public/site-config.json','public/data/observations.json'];
